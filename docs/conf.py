# -*- coding: utf-8 -*-
#
# NGDS documentation build configuration file, created by
...
latex_documents = [
  ('index', 'piano.tex', u'Piano Documentation',
   u'Logicdrop', 'manual'),
]
...
man_pages = [
    ('index', 'piano', u'Piano Documentation',
     [u'Logicdrop'], 1)
]
...
texinfo_documents = [
  ('index', 'Piano', u'Piano Documentation',
   u'Logicdrop', 'Piano', 'One line description of project.',
   'Miscellaneous'),
]
